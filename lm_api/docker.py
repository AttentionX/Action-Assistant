...
prompt_instruction = '''
Convert the following command into a valid docker command. Only return the docker command with no other information or characters!
'''